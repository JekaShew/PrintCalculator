...
class PaperSize extends React.Component {
    constructor(props) {
        super(props);
...
function mapStateToProps(state) {
    ...
    return {
        ...
        value: state.paperSizes,
    };
}
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(PaperSize));