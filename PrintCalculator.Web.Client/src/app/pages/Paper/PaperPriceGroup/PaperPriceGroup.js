...
class PaperPriceGroup extends React.Component {
    constructor(props) {
        super(props);
    ...
    renderEdit() {
       if (this.state.edit.show || this.state.details.show) {
            ...
            return (
                <CrudForm
                    ui={formStyle.x1}
                    model={dataModels.paperPriceGroup}
        ...
        if (this.state.table.show) {
            return (
                <Table
                    ...
                    sr={{ textAlign: 'left' }}
                    sh={{ textAlign: 'left' }}
                    model={dataTables.paperPriceGroups}
...
function mapStateToProps(state) {
    ...
    return {
        ...
        value: state.paperPriceGroups,
    };
}
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(PaperPriceGroup));