...
class PaperCoefficient extends React.Component {
    constructor(props) {
        super(props);
    ...
    renderEdit() {
        if (this.state.edit.show) {
            ...
            return (
                ...
                <CrudForm
                    ui={formStyle.x1}
                    model={dataModels.paperCoefficient}
        ...
        if (this.state.table.show) {
            return (
                <Table
                    ...
                    sr={{ textAlign: 'left' }}
                    sh={{ textAlign: 'left' }}
                    model={dataTables.paperCoefficiets}
...
function mapStateToProps(state) {
    ...
    return {
        ...
        value: state.paperCoefficients,
    };
}
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(PaperCoefficient));