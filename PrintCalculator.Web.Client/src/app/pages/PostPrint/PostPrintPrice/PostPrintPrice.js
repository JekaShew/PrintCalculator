...
class PostPrintPrice extends React.Component {
    constructor(props) {
        super(props);
    ...
    renderEdit() {
        if (this.state.edit.show || this.state.details.show) {
            ...
            return (
                <CrudForm
                    ui={formStyle.x1}
                    model={dataModels.postPrintPrice}
        ...
        if (this.state.table.show) {
            return (
                <Table
                    ...
                    sr={{ textAlign: 'left' }}
                    sh={{ textAlign: 'left' }}
                    model={dataTables.postPrintPrices}
...
function mapStateToProps(state) {
    ...
    return {
        ...
        value: state.postPrintPrices,
    };
}
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(PostPrintPrice));