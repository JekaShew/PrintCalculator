...
function mapStateToProps(state) {
    ...
    return {
        ...
        value: state.printTypes,
    };
}
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(PrintType));