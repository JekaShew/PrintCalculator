...
function mapStateToProps(state) {
    ...
    return {
        ...
        value: state.unitMeasures,
    };
}
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(UnitMeasure));