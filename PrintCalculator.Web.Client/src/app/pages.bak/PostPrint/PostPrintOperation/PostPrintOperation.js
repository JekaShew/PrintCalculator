...
class PostPrintOperation extends React.Component {
    constructor(props) {
        super(props);
    ...
    renderEdit() {
        if (this.state.edit.show) {
            ...
            return (
                ...
                <CrudForm
                    ui={formStyle.x1}
                    model={dataModels.postPrintOperation}
        ...
        if (this.state.table.show) {
            return (
                <Table
                    ...
                    sr={{ textAlign: 'left' }}
                    sh={{ textAlign: 'left' }}
                    model={dataTables.postPrintOperations}
...
function mapStateToProps(state) {
    ...
    return {
        ...
        value: state.postPrintOperations,
    };
}
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(PostPrintOperation));