...
class PostPrintGroup extends React.Component {
    constructor(props) {
        super(props);
    ...
    renderEdit() {
        if (this.state.edit.show) {
            ...
            return (
                ...
                <CrudForm
                    ui={formStyle.x1}
                    model={dataModels.postPrintGroup}
        ...
        if (this.state.table.show) {
            return (
                <Table
                    ...
                    sr={{ textAlign: 'left' }}
                    sh={{ textAlign: 'left' }}
                    model={dataTables.postPrintGroups}
...
function mapStateToProps(state) {
    ...
    return {
        ...
        value: state.postPrintGroups,
    };
}
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(PostPrintGroup));