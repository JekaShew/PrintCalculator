...
class PostPrintTarget extends React.Component {
    constructor(props) {
        super(props);
    ...
    renderEdit() {
        if (this.state.edit.show) {
            ...
            return (
                ...
                <CrudForm
                    ui={formStyle.x1}
                    model={dataModels.postPrintTarget}
        ...
        if (this.state.table.show) {
            return (
                <Table
                    ...
                    sr={{ textAlign: 'left' }}
                    sh={{ textAlign: 'left' }}
                    model={dataTables.postPrintTargets}
...
function mapStateToProps(state) {
    ...
    return {
        ...
        value: state.postPrintTargets,
    };
}
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(PostPrintTarget));