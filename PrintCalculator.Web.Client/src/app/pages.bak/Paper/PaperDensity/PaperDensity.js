...
class PaperDensity extends React.Component {
    constructor(props) {
        super(props);
        ...
        if (this.state.table.show) {
            return (
                <Table
                    ...
                    sr={{ textAlign: 'left' }}
                    sh={{ textAlign: 'left' }}
                    model={dataTables.paperDensities}
...
function mapStateToProps(state) {
    ...
    return {
        ...
        value: state.paperDensities,
    };
}
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(PaperDensity));