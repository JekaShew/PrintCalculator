...
class PaperType extends React.Component {
    constructor(props) {
        super(props);
...
function mapStateToProps(state) {
    ...
    return {
        ...
        value: state.paperTypes,
    };
}
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(PaperType));