...
class TechProcessOption extends React.Component {
    constructor(props) {
        super(props);
    ...
    renderEdit() {
        if (this.state.edit.show) {
            ...
            return (
                ...
                <CrudForm
                    ui={formStyle.x1}
                    model={dataModels.techProcessOption}
        ...
        if (this.state.table.show) {
            return (
                <Table
                    ...
                    sr={{ textAlign: 'left' }}
                    sh={{ textAlign: 'left' }}
                    model={dataTables.techProcessOptions}
...
function mapStateToProps(state) {
    ...
    return {
        ...
        value: state.techProcessOptions,
    };
}
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(TechProcessOption));