...
class StorageProduct extends React.Component {
    constructor(props) {
        super(props);
    ...
    renderEdit() {
        if (this.state.edit.show) {
            ...
            return (
                ...
                <CrudForm
                    ui={formStyle.x1}
                    model={dataModels.storageProduct}
        ...
        if (this.state.table.show) {
            return (
                <Table
                    ...
                    sr={{ textAlign: 'left' }}
                    sh={{ textAlign: 'left' }}
                    model={dataTables.storageProducts}
...
function mapStateToProps(state) {
    ...
    return {
        ...
        value: state.storageProducts,
    };
}
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(StorageProduct));